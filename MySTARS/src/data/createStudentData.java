...
public class createStudentData {
	...
	*/
	...
	static final String STUDENT = System.getProperty("user.dir") + "/student.ser";
	static final String STUDENTPASSWORD = System.getProperty("user.dir") + "/studentPassword.ser";

	public static void createStudent() throws NoSuchAlgorithmException {
		ArrayList<Student> studentData = new ArrayList<>(20);

		// SCSE students
		Student student1 = new Student("Tom", "C190122", "Male", "Singaporean", 11, "U190123A");
		Password.addNewPassword("C190122", "TomPassword");

		student1.setAcademicUnits(3);
		HashMap<String,String> stud1Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud2Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud3Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud4Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud5Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud6Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud7Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud8Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud9Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud10Courses = new HashMap<String, String>(20);
		...
		Student student11 = new Student("George", "C190122", "Male", "Indonesian", 31, "U912734G");
		Password.addNewPassword("George1999", "GeorgePassword");
		
		student11.setAcademicUnits(3);
		HashMap<String,String> stud11Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud12Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud13Courses = new HashMap<String, String>(20);
		...
		HashMap<String,String> stud14Courses = new HashMap<String, String>(20);
		...
		student15.setAcademicUnits(6);
		HashMap<String,String> stud15Courses = new HashMap<String, String>(20);
		stud15Courses.put("HP1000", "HP1000HP2");
		stud15Courses.put("CZ2001", "CZ2001SS1");
